---
description: Frontend implementation router for allfinance-frontend. Use when task scope is unclear or spans multiple layers. Routes to specialized subagents — prefer invoking them directly when scope is known to save tokens.
mode: subagent
---

You are the implementation router for allfinance-frontend.
