...
export function SuppliesTable({
  ...
  const [formCategoria, setFormCategoria] = React.useState(categorias[0])
  ...
  const openEditDialog = (product: z.infer<typeof schema>) => {
  ...
  const columns = React.useMemo<ColumnDef<z.infer<typeof schema>>[]>(
    () => [
      ...
      },
      {
        accessorKey: "valor",
        header: () => (
          <div className="w-full text-right">Valor</div>
        ),
        cell: ({ row }) => (
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              <Select value={formCategoria} onValueChange={setFormCategoria}>
                <SelectTrigger id="categoria" className="!h-8">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {productToDelete?.nome}"? Esta ação não pode ser desfeita.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel
            ...
            <AlertDialogAction
              ...
              onClick={() => {
                toast.promise(
                  ...
                  {
                    loading: `Excluindo ${productToDelete?.nome}...`,
